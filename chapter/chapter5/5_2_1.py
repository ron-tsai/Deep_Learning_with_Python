...
#建文件夹
train_cats_dir=os.path.join(train_dir,'cats')#粘起来
os.mkdir(train_cats_dir)#建档案夹
...
#作者遗漏
original_dataset_dir='F:\Google_download\dogs-vs-cats (1)\kaggle_original_data/train'
